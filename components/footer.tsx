          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <p className="text-sm text-amber-200">123 Sweet Lane, Mumbai, Maharashtra 400001</p>
              </div>
              <div className="flex gap-3">
                <svg
                  className="w-5 h-5 text-amber-400 flex-shrink-0 mt-0.5"
                ...
                <p className="text-sm text-amber-200">+91 98765 43210</p>
              </div>
              <div className="flex gap-3">
                <svg
                  className="w-5 h-5 text-amber-400 flex-shrink-0 mt-0.5"
                ...
                <p className="text-sm text-amber-200">hello@surbhisweetmart.com</p>
              </div>
            </div>
          </div>
        </div>
